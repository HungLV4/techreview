...
class EngadgetSpider(Spider):
	...
	def start_requests(self):
		...
		data = json.loads('{"cat":[{"name":"Computers","products":[{"title":"Desktops","url":"desktops"},{"title":"Laptops/Portables","url":"laptops"}]},{"name":"Mobile","products":[{"title":"Cellphones","url":"cellphones"},{"title":"Tablets","url":"tablets"}]},{"name":"Personal Tech","products":[{"title":"Headphones","url":"headphones"},{"title":"Portable Media Players","url":"portable-media-players"},{"title":"E-book Readers","url":"e-book-readers"},{"title":"Fitness","url":"fitness"},{"title":"Misc devices","url":"misc"}]}]}')
	...
	def parse(self, response):
		# print response.url, response.meta['product']
